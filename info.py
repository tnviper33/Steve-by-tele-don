...
auth_channel = environ.get('AUTH_CHANNEL', "-1002021705186")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://arun:<password>@cluster089.ilwjafv.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "cluster089")
